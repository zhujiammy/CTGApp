...
public class ReceivingAddressAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View baseView;
        baseView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.receivingaddress_data, viewGroup, false);
