...
public class SwitchingEnterprisesAdapter extends RecyclerView.Adapter implements View.OnClickListener {

    public static final int VIEW_TYPE_ITEM = 1;
    public static final int VIEW_TYPE_EMPTY = 0;
    private Context context;
    int type = 1;
    public SwitchingEnterprisesAdapter(Context context){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View baseView;
        baseView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.switchgenterprises_data, viewGroup, false);
